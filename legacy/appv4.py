...
class CourseManagerApp(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.stacked_widget.raise_()  # Upewniamy się, że jest nad postacią
    ...
    def update_anime_character(self):
        if self.current_style == "Sakura Pink" and os.path.exists("anime_character.png"):
            ...
            self.anime_character_label.lower()  # Upewniamy się, że jest pod UI
            self.stacked_widget.raise_()  # stacked_widget nad postacią
    ...
    def resizeEvent(self, event):
        # Aktualizacja pozycji postaci anime
        self.update_anime_character()
    ...
    def update_courses_list(self):
        ...
        self.update_grades_form()  # Aktualizacja ocen po zmianie kursów
    ...
    def update_grades_form(self):
        ...
        for grade in course["grades"]:
            try:
                ...
                item.setData(Qt.UserRole, grade)  # Przechowujemy dane oceny
    ...
    def add_course(self):
        ...
        for checkbox in self.days_checkboxes.items():
