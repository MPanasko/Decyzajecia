...
class CourseManagerApp(QMainWindow):
    ...
    def init_ui(self):
        ...
        # Półprzezroczystość dla stacked_widget
        ...
        opacity_effect_btn.setOpacity(0.9)
    ...
    def update_anime_character(self):
        if self.current_style == "Sakura Pink" and os.path.exists("anime_character.png"):
            ...
            self.anime_character_label.move(
                self.main_area.width() - 200 - 10,
                self.main_area.height() - 300 - 50  # 50 pikseli na przycisk analizy
            )
            self.anime_character_label.lower()  # Pod UI
            self.stacked_widget.raise_()  # UI nad postacią
            # Sprawdzanie, czy analyze_btn istnieje
            if hasattr(self, 'analyze_btn'):
                self.analyze_btn.raise_()  # Przycisk analizy nad postacią
            self.anime_character_label.show()
            logging.info("Postać anime załadowana i wyświetlona")
        else:
            self.anime_character_label.hide()
    ...
    def apply_style(self, style_name):
        ...
        styles = {
            "Sakura Pink": {
                ...
                "button_color": "#ffb6c1",
                "button_text": "#5a0032",
                "list_color": "rgba(255, 209, 220, 0.9)",  # Półprzezroczyste tło listy
                "group_color": "rgba(255, 236, 241, 0.9)",  # Półprzezroczyste tło groupbox
                "menu_color": "#ffc0cb"
            },
            "Windows XP": {
                "bg_color": "#e4ecf5",
